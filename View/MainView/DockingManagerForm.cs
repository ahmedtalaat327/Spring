...
namespace Spring
{
    public partial class DockingManagerForm : MetroForm
    {
        ...
        this.editControl1.LoadFile(Path.GetDirectoryName(Application.ExecutablePath) + @"\..\..\..\DockingManagerForm.cs");
            ...
            this.dockingManager1.SetAutoHideOnLoad(this.panel2, true);
            ...
            UpdateLayout();
#endif
            // var addUser = this.treeViewAdv1.Nodes[0].Nodes[1] as TreeNodeAdv;
            // addUser.ExpandImageIndexChanged () => { MessageBox.Show("Test"); };
            /*
            //Create dataTable
            ...
            */
            ...
            staticBarItem1.CategoryIndex = 0;
            staticBarItem1.Text = "loggerName";
            staticBarItem1.SizeToFit = true;
            staticBarItem1.ID = "loggerName";
            staticBarItem1.Tag = "loggerName";
            staticBarItem1.CustomTextFont = new Font("Arial", 9);
            this.bar1.BarName = "Menu";
            */
            this.progressBarAdv1.TextVisible = false;
            this.progressBarAdv1.ProgressStyle = ProgressBarStyles.Metro;
            ...
            this.progressBarAdv1.DataBindings.Add(new Binding("Visible", VMCentral.DockingManagerViewModel, "Loading"));
            ...
            Syncfusion.Windows.Forms.Tools.CommandBar commandBar1 = new Syncfusion.Windows.Forms.Tools.CommandBar();
            this.mainFrameBarManager1.DetachedCommandBars.Add(commandBar1);
            commandBar1.BackColor = System.Drawing.SystemColors.Desktop;
            commandBar1.Controls.AddRange(new System.Windows.Forms.Control[] {
                                                                                 myPanel});
            ...
            commandBar1.RowIndex = 0;
            commandBar1.RowOffset = 0;
            commandBar1.TabIndex = 0;
            commandBar1.TabStop = false;
            ...
            {
                new BarItem() { BarName="baarItem1", Text="My Account" },
                new BarItem() { BarName="baarItem2", Text="Logout?" },
                new BarItem() { BarName="baarItem2", Text="Help" }
            });
            commandBar1.PopupMenu = popup_Menu;
            commandBar1.PopupMenu.ParentBarItem.Items[0].Click += (evt, obj) => {
            ...
            this.treeViewAdv1.AfterSelect += (eve, ob) =>
            {
                // RaiseClick(this.treeViewAdv1.SelectedNode);
            };

            
            //((TreeNodeAdv)treeViewAdv1.Nodes[0]).con = false;
            //this.treeViewAdv1.Nodes[0].Nodes[0].Enabled = false;
            
            //this.treeViewAdv1.DataBindings.Add(new Binding("Text", DockingManagerViewModel, "myNodes"));
            //new MetroForm() { Size = new Size(300, 300), Visible = true , StartPosition = FormStartPosition.CenterScreen};
            //new LoginForm().Show();

            //assign properties to [visible property of this window]
            this.DataBindings.Add(new Binding("Visible", VMCentral.DockingManagerViewModel, "WindowVisible"));
            //Metro form needs to be shown then you can control visibilty orn not.
            this.Show();

            List<string> barNames = new List<string>();
            barNames.Add("&BUILD");
            barNames.Add("&PROJECT");
            barNames.Add("&DEBUG");
            barNames.Add("TEA&M");
            barNames.Add("F&ORMAT");
            barNames.Add("&TOOLS");
            barNames.Add("TE&ST");
            barNames.Add("&ANALYZE");
            
            for (int q = 0; q < barNames.Count; q++)
            {
                for (int x = 0; x < this.bar1.Items.Count; x++)
                {
                    //3->11
                    if (bar1.Items[x].Text == barNames[q])
                    {
                        this.bar1.RemoveItem(this.bar1.Items[x]); break;
                    }
                }
            }
        ...
        void RaiseClick(TreeNodeAdv adv)
        {
            ...
            //tabPageAdvN.Controls.Add(this.editControl1);
            tabPageAdvN.Image = null;
            tabPageAdvN.ImageSize = new System.Drawing.Size(16, 16);
            tabPageAdvN.Location = new System.Drawing.Point(0, 30);
            tabPageAdvN.Name = "" + adv.Text;
            tabPageAdvN.ShowCloseButton = true;
            tabPageAdvN.Size = new System.Drawing.Size(254, 147);
            tabPageAdvN.TabForeColor = System.Drawing.SystemColors.InfoText;
            ...
            for (int d = 0; d < tabControlAdv1.TabPages.Count; d++)
            {
                ...
                else
                {
                    ...
                    if (d == tabControlAdv1.TabPages.Count - 1)
                    {
                        tabControlAdv1.Controls.Add(tabPageAdvN);
        ...
        private void UpdateLayout()
        {
            ...
            this.dockingManager1.DockControl(this.panel2, this, DockingStyle.Bottom, 30);
            this.dockingManager1.SetAutoHideMode(this.panel2, false);
        }
        #endregion

        #region Variables
        QuickToolsView panel5 = null;
        /*
        /// <summary>
        /// DropDownItems
        /// </summary>
        ...
        */
        ...
        {
            this.panel5 = new QuickToolsView();
            this.dockingManager1.SetDockLabel(this.panel5, "Quick Tools Box");
